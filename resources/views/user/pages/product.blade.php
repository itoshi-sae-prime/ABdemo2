            ...
            <div class="flex justify-between items-center px-3 py-1 border-b-2 bg-white shadow-lg" style="position: sticky; top: 0; z-index:1">
                ...
                <div class="flex justify-center items-center gap-2">
                    ...
                    <div class="border-2 rounded-md">
                        <form class="flex" action="{{ route('user.pages.product') }}" method="GET" id="searchForm">
            ...
            <table class="table-auto w-full">
                <thead class="py-5 border-b-2 w-100">
                    <tr class="my-5 bg-slate-300">
                        ...
                        <th class="text-yellow-500 text-[15px] text-center py-4 px-3">Barcode</th>
                        <th class="text-yellow-500 text-[15px] text-center pl-2">Product</th>
                ...
                <tbody class="">
                    ...
                    <form action="{{ route('product.delete.selected') }}" method="POST">
                        <tr id="toggleDisplay-{{ $row->id }}" class="font-semibold hover:bg-blue-100 border-b-2 m-1">
                            ...
                            <td class="mx-1 px-3 text-center">{{ $row->product_barcode }}</td>
                            <td class="p-2 w-[40%] text-center">{{ $row->product_name }}</td>
