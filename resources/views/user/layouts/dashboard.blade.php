                ...
                <ul class="flex flex-col flex-grow" style="justify-content: space-between;">
                    <li>
                        <ul>
                            ...
                            <li class="mb-1 mt-3">
                                <a href="{{ route('user.pages.dashboard')}}" class="text-slate-500 block px-3 py-2 font-semibold rounded-lg hover:text-white hover:bg-slate-800"><i class=" fa-solid fa-gauge"></i><span class="pl-2">Dashboard</span></a>
                            </li>
                            <li class="mb-1">
                                <a href="{{ route('user.pages.product') }}" class="text-slate-500 block px-3 py-2 font-semibold rounded-lg hover:text-white hover:bg-slate-800"><i class="fa-solid fa-bag-shopping"></i><span class="pl-2">Product</span></a>
                            </li>
                            <!-- <li class="mb-1">
